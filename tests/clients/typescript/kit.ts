import { type Address, address, AccountRole, type IInstruction, getProgramDerivedAddress, getAddressCodec } from "@solana/kit";
...
export class QuasarEscrowClient {
  ...
  async createMakeInstruction(input: MakeInstructionInput): Promise<IInstruction> {
    ...
    accountsMap["escrow"] = (await getProgramDerivedAddress({
      programAddress: PROGRAM_ADDRESS,
      seeds: [
        new Uint8Array([101, 115, 99, 114, 111, 119]),
        getAddressCodec().encode(input.maker),
      ],
    }))[0];
    const argsCodec = getStructCodec([
      ["deposit", getU64Codec()],
  ...
  async createTakeInstruction(input: TakeInstructionInput): Promise<IInstruction> {
    const accountsMap: Record<string, Address> = {};
    accountsMap["rent"] = address("SysvarRent111111111111111111111111111111111");
    accountsMap["tokenProgram"] = address("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");
    accountsMap["systemProgram"] = address("11111111111111111111111111111111");
  ...
  async createRefundInstruction(input: RefundInstructionInput): Promise<IInstruction> {
    const accountsMap: Record<string, Address> = {};
    accountsMap["rent"] = address("SysvarRent111111111111111111111111111111111");
    accountsMap["tokenProgram"] = address("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");
    accountsMap["systemProgram"] = address("11111111111111111111111111111111");
