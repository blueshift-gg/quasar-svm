...
describe("Web3.js Layer - Basic Tests", () => {
  let vm: QuasarSvm;
  ...
  it.skip("should load custom program", () => {
    const programId = Address.unique();
  ...
  it.skip("should execute instruction", () => {
    const programId = Address.unique();
    const elf = loadTestProgram("test_program.so");
...
describe("Web3.js Layer - Account Management", () => {
  let vm: QuasarSvm;
  ...
  it.skip("should create and modify accounts", () => {
